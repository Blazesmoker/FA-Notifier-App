...
class JournalDetailsRepositoryImpl implements JournalDetailsRepository {
  const JournalDetailsRepositoryImpl({
  ...
  final JournalLoadCoordinator _loadCoordinator;
  ...
  @override
  Future<JournalLoadResult> loadJournal(String journalId) {
