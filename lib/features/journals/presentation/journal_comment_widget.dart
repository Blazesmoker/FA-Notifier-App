...
class JournalCommentWidget extends StatefulWidget {
  ...
  @override
  State<JournalCommentWidget> createState() => _JournalCommentWidgetState();
}

class _JournalCommentWidgetState extends State<JournalCommentWidget> {
