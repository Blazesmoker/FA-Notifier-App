...
class SearchResultsGrid extends StatefulWidget {
  ...
  @override
  SearchResultsGridState createState() => SearchResultsGridState();
}
              ...
              onTap: () {
                Navigator.push(
                  ...
                  SubmissionDetailsScreen.route(
                    imageUrl: image['url'],
                    submissionId: image['uniqueNumber'],
            ...
            _FavSearchTile(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  SubmissionDetailsScreen.route(
                    imageUrl: left['url'],
                    submissionId: left['uniqueNumber'],
                    skipInitialWatchCheck: true,
                  ),
                );
              },
            ...
            _FavSearchTile(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  SubmissionDetailsScreen.route(
                    imageUrl: right['url'],
                    submissionId: right['uniqueNumber'],
                    skipInitialWatchCheck: true,
                  ),
                );
              },
...
class _FavSearchTileState extends State<_FavSearchTile> {
  ...
  Widget build(BuildContext context) {
    ...
    final submissionId = widget.item['uniqueNumber'] as String;
