  ...
  Widget _select(String name, String title) {
    ...
    return Padding(
      ...
      child: DropdownButtonFormField<String>(
        ...
        isExpanded: true,
        style: const TextStyle(color: Colors.white),
        dropdownColor: furAffinitySettingsGroup,
        iconEnabledColor: furAffinitySettingsAccent,
        decoration: InputDecoration(
          labelText: title,
        ...
        onChanged: field?.enabled ?? false
            ? (value) {
                if (value != null) _controller.setValue(name, value);
              }
            : null,
      ),
    );
