                      ...
                      return SliverMasonryGrid.count(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _SubmissionSelectionTile(
                            ...
                            enabled: !_mutating,
                            onToggle: () =>
                                _toggleSubmission(submission.id),
        ...
        children: [
          SizedBox(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                final counterWidth =
                    (constraints.maxWidth - 120).clamp(72.0, 160.0).toDouble();
                return Stack(
                ...
                Align(
                  ...
                  child: Material(
                    ...
                    child: IconButton(
                      ...
                      onPressed: enabled && deleteEnabled ? onDelete : null,
                      icon: Icon(
...
class _SubmissionSelectionTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final rawAspect = submission.width / submission.height;
    final aspect = rawAspect.clamp(0.55, 1.8).toDouble();
    return Semantics(
      button: true,
      selected: selected,
                  ...
                  children: [
                    FaThumbnailOutline(
                      ...
                      child: FaNetworkImage(
                        submission.thumbnailUri.toString(),
                        fit: BoxFit.cover,
                        semanticLabel: submission.title,
                        errorBuilder: (context, error, stackTrace) {
                          return const ColoredBox(
                            color: Color(0xFF2A2A2A),
                            child: Center(
