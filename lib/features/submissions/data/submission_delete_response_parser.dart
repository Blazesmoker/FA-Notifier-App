...
SubmissionDeleteConfirmationData? parseSubmissionDeleteConfirmation(
  String htmlBody,
) {
  ...
  return SubmissionDeleteConfirmationData(
...
bool isSubmissionDeletionConfirmed(String htmlBody) {
  final document = html_parser.parse(htmlBody);
