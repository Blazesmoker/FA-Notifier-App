...
String decodeSubmissionResponseBody(List<int> bodyBytes) {
  try {
...
String decodeSubmissionFavoriteLinksBody(String body, List<int> bodyBytes) {
  try {
    return body;
  } on FormatException {
    return utf8.decode(bodyBytes, allowMalformed: true);
...
Future<dom.Document> parseSubmissionHtmlDocument(String htmlBody) {
...
SubmissionUserPageActions parseSubmissionUserPageActions(dom.Document document) {
  ...
  return SubmissionUserPageActions(
    isClassic: isClassic,
    watchLink: watchLink,
