...
class ProfileFavoritesSliver extends StatefulWidget {
  final String username;
  final bool isOwnProfile;
  final bool selectionMode;
  final ValueChanged<int> onSelectionCountChanged;

  const ProfileFavoritesSliver({
  ...
  @override
  ProfileFavoritesSliverState createState() => ProfileFavoritesSliverState();
}

class ProfileFavoritesSliverState extends State<ProfileFavoritesSliver> {
  String? _nextPageUrl;
  ...
  @override
  void didUpdateWidget(ProfileFavoritesSliver oldWidget) {
  ...
  Widget _buildImageContainer(Map<String, dynamic> im, double width, double height) {
    ...
    final submissionId = im['uniqueNumber'] as String;
