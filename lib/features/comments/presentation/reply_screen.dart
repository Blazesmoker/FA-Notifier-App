...
class _ReplyScreenState extends State<ReplyScreen> {
  ...
  SubmissionCommentRepository get _commentRepository =>
      widget.commentRepository ?? context.read<SubmissionCommentRepository>();
  ...
  void _sendReply() async {
    ...
    final replyId = _commentRepository.resolveReplyId(
      replyLink: widget.comment['replyLink'] ?? '',
